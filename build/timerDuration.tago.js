...
async function timerDuration(context, scope) {
  ...
  const token = context.token;
  const resources = new import_sdk2.Resources({ token });
...
var timerDuration_default = new import_sdk2.Analysis(timerDuration, { token: "a-12fb193a-7a9a-4332-8a5d-f80abd45c756" });
