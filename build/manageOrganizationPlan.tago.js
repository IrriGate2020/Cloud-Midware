 ...
 * -------------------
 * Generated by     :: rafael
 * Generated at     :: Monday, July 13, 2026 at 1:34 PM Coordinated Universal Time
...
async function manageOrganizationPlan(context, scope) {
  ...
  await sendValidation(resources, inputDeviceId, `Plano ${plan.label} aplicado para ${organization.name}. Limites aplicados: ${plan.alertLimit} alertas, ${plan.reportLimit} relat\xF3rios e reten\xE7\xE3o de ${plan.retentionDays} dias. Devices atualizados: ${devicesUpdated}. Usu\xE1rios atualizados: ${organizationUsers.length}. Alertas restantes: ${status.remaining.alerts}. Relat\xF3rios restantes: ${status.remaining.reports}.`, "success", data.session_id);
